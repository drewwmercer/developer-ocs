...
VALUES
    ...
    ('2017-11-26 00:24:43', 'Node Socket Server Development', 'We are looking for Node.js ninjas who want to help us design cutting edge scalable products to meet our rapidly growing business. We are building out a team and looking for multiple levels but you should have at least 3 years of programming experience.', 'Node.js', true, 2),
    ('2017-11-27 00:26:38', 'Angular Website Enhancement', 'Summary of Challenge:  Implement Angular website enhancement. Add searchable tags on FAQ section of website and add a few navigation items onto homepage.   \n\nTool Logic/Requirements\n•	FAQ Section\no	List items will be pulled from a SharePoint list\no	Depend','Angular', true, 2),
